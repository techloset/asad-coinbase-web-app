    ...
    <>
      ...
      <div className="font-poppins heroBg lg:min-h-[100vh] sm:min-h-[130vh] xs:min-h-[160vh]  grid lg:grid-cols-2 sm:grid  sm:grid-cols-1 xs:grid  xs:grid-cols-1 ">
        <div className='xl:w-[529px] lg:w-[90%] sm:w-[80%] xs:w-[90%] mx-auto mt-36 xs:mt-16 xl:ml-48 lg:ml-36'>
          ...
          <p className='  mt-8 leading-7 text-lg text-white font-normal w-[460px] h-[54px]'>CoinBase is a platform for trading your bitcoin and
      ...
      <div className='max-w-[90%] mx-auto lg:mb-[-135px] lg:mt-[-80px]'>
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 sm:mx-auto xs:grid-cols-1 xs:mx-auto mt-12'>
          ...
          <div className='sm:mt-10 lg:mt-0 xs:mt-9'>
            <h2 className='font-bold lg:text-[28px] sm:text-2xl xs:text-2xl bg-gradient-to-b from-[#FD749B]  to-[#281AC8] bg-clip-text text-transparent xs:text-center sm:text-center lg:text-left lg:w-[315px]'>Welcome to CoinBase</h2>
              ...
              <div className='col-span-4'>
                <div className='mt-14'>
                  <div className='flex justify-evenly'>
                    <img src={smallbtc} alt="" className='-mt-8' />
                    <p className='text-sm font-normal mt-1 -ml-9'>BTC</p>
                    <div className='ml-3'>
                  ...
                  <div className='flex justify-evenly mt-12 '>
                    <img src={eth} alt="" className='ml-3 -mt-7' />
                    <p className='text-sm font-normal mt-1  -ml-8'>ETH</p>
                    <div className='ml-6'>
      ...
      <div className='lg:mt-36'>
        <div className='max-w-[90%] mx-auto'>
          ...
          <div className='flex justify-center items-center relative mt-12'>
            ...
            <div className='border-[1px] border-[#888888] h-[286px] bg-white relative left-36 -z-10 w-[33%] grayscale p-10 rounded-[15px] xs:hidden sm:hidden lg:block'>
            ...
            <div className='border-[1px] border-[#FD749B] shadowBlog  bg-white relative sm:w-[80%] lg:w-[30%] xs:w-[95%] z-10 p-11 xs:p-5  '>
            ...
            <div className='border-[1px] border-[#888888] h-[286px] relative -z-10 right-16 w-[27%] grayscale p-10 rounded-2xl xs:hidden sm:hidden lg:block'>
              <p className='flex justify-start mt-3 text-[#888888] text-xs'>
                <span> 19 June, 2019 </span>
                <hr className='border-t-2 w-4 rotate-90 mx-2 mt-2' />
                <span>BUSINESS</span>
      ...
      <div className='section7Bg min-h-[180vh] xs:min-h-[150vh] lg:mt-[-40px]'>
        ...
        <div className='max-w-[80%] mx-auto '>.
          ...
          <div className='w-[46%] xs:w-[95%] mx-auto mt-12 text-white'>
      ...
      {/* Section 8 */}
      <div className='max-w-[80%] mx-auto md:mb-[-120px] md:mt-[-80px] lg:mb-[-120px] lg:mt-[-80px]'>
        <div className='flex flex-col items-center'>
          <div className='xs:py-5'><img src={download} alt="" /></div>
          <hr className='w-12 border-2 mx-auto mt-5 border-[#FD749B] rounded-md' />
          <div className='w-[378.42px] xs:w-[80%] mt-7'>
      ...
      {/* Section 10 */}
      <div className='xl:mt-[23%] lg:mt-[28%] md:mt-[45%] sm:mt-[60%]  xs:mt-20'>
        <div className='flex flex-col items-center '>
          <h2 className='xs:px-5'><img src={section10} alt="" /></h2>
          <hr className='w-12 border-2 mx-auto mt-5 border-[#FD749B] rounded-md' />
          <div className='lg:w-[27%] sm:w-[38%] xs:w-[80%] mt-7'>
            <p className='text-base text-center font-normal leading-10'>Subscribe to our newsletter for daily/weekly update of our products and services.</p>
          </div>
        </div>
