...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div className="grid lg:grid-cols-2 sm:grid  sm:grid-cols-1 xs:grid  xs:grid-cols-1 heroBg min-h-[130vh] xs:min-h-[160vh]">
        <div className='mx-auto mt-36 xs:mt-16 xl:ml-48 lg:ml-36 xl:w-[75%] lg:w-[90%] sm:w-[80%] xs:w-[90%] '>
          <h2 className='text-white font-["Open Sans"] lg:leading-normal sm:leading-normal xs:leading-snug lg:text-[40px] sm:text-4xl xs:text-3xl font-normal'>
