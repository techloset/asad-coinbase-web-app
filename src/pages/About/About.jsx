...
function About() {
    return (
        <>
            <div className="heroBg lg:min-h-[100vh] sm:min-h-[120vh]  xs:min-h-[120vh] lg:flex lg:justify-around sm:grid  sm:grid-cols-1 xs:grid  xs:grid-cols-1 md:pb-[280px]">
            ...
            {/* Section 2 */}
            <div className='mt-20 border-2 w-[70%] xs:w-[90%] mx-auto rounded-2xl border-pink-300'>
