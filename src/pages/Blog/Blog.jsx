...
function Blog() {
    ...
    return (
        <>
            ...
            <div className="heroBg lg:min-h-[110vh]   sm:min-h-[140vh] xs:min-h-[140vh]  lg:flex lg:justify-around sm:grid  sm:grid-cols-1 xs:grid  xs:grid-cols-1  md:pb-[280px]">
                ...
                <div className='md:mt-0 sm:mx-auto lg:mx-0 lg:mr-32' >
